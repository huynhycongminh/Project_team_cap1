                    ...
                    this.state.cars.map((car) => (
                      ...
                      <td>
                        <button className="edit-button">
                          <img src="./image/adminListofProduct/edit_pie_chart_report_48px.png" alt="Edit img" className="edit-img" />
                        </button>
                      </td>
                      <td>
                        <button className="delete-button">
                          <img src="./image/adminListofProduct/recycle_bin_48px.png" alt="Delete img" className="delete-img" />
                        </button>
                      </td>
                    </tr>
                    ))
